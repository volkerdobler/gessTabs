...
//
// Deliberately never read: value-label sets (record type 3/4), variable
// labels, measurement level (extension subtype 11). In a gessTabs workflow
// the labels are (re)defined in the script — directly or auto-generated by
// `#define ... syntax` — so the .sav's own labels are not the extension's
// concern. See docs/variable-model-design.md §11.7.
//
